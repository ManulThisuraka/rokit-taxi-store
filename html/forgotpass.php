...
<form action="Processf.php" method="post">
  ...
  <div class="container">
    ...
    <input type="email" placeholder="Enter your E-Mail" name="email" required><br>

    <label for="userName"><b>User Name</b></label><br>
    <input type="username" placeholder="Enter your Username" name="userName" required value=""><br>
